...
// 							I am a Student of Manipal University Jaipur pursuing
// 							B.Tech in Information Technology. Focused,
...
// 	  return {
// 		props: { experiences: [] } // Handle errors by returning an empty arra
// 	  };
// 	}
//   };
				...
				<ScrollAnimation>
					...
					>
						...
						<p className="font-clash text-4xsm sm:text-3xsm xl:text-sm mb-3 sm:mb-4 xl:mb-[28px] xxl:mb-[36px]">
							...
							B.Tech in Information Technology. Focused,
							quick-learner and Passionate about coding and Back-end engineering of software applications.
						</p>
						<div className="flex flex-row items-center justify-between w-[192px] sm:w-[212px] md:w-[216px] xl:w-[224px] ">
							<motion.div
								initial="rest"
...
// 	  console.error('Error fetching experiences:', error); // Debugging line
// 	  return {
// 		props: { experiences: [] }, // Handle errors by returning an empty array
// 	  };
// 	}
//   };
